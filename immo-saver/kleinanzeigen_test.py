...
def getTitleImageUrlFromDriver(driver):
    #galleryimage-element current
    #'galleryimage-large--cover j-ad-image-selected'
    ...
    for meta in all_meta:
        ...
        if "contentUrl" in text:
            #<meta itemprop="contentUrl" content="https://img.kleinanzeigen.de/api/v1/prod-ads/images/aa/aa910498-2e6d-46b3-8156-f9426d485eb6?rule=$_59.AUTO">
...
def getSizesAndYearFromDriver(driver):
    #detailsDiv = driver.find_elements(By.ID,'viewad-details')
...
write_json(data)
# Append the new element to the "immos" list
